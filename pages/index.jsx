        ...
        <div className={styles.homeContent}>
          <Row className={styles.threeContentOfHome}>
            <Col xs={12} md={4}
              ...
              data-aos-offset="400">
              <h3>הנוחות והבטיחות</h3>
              <p>דלתות אוטומטיות מספקות נוחות ובטיחות, עם אפשרות לפתיחה וסגירה אוטומטית, והן אידיאליות למקומות עתירי תנועה כמו בתי חולים ושדות תעופה. הדלתות חוסכות זמן, אנרגיה ומפחיתות סיכון לפציעות.</p>
            </Col>
            <Col xs={12} md={4}
              ...
              data-aos-offset="400">
              <h3>מחיר משתלם</h3>
              <p>דלתות אוטומטיות הפכו לסטנדרט במקומות ציבוריים כמו מרכזי מסחר, שדות תעופה ובתי מלון. בעלי עסקים ומנהלי נכסים בוחרים בדלתות פאר אנפון בזכות נגישות וקלות השימוש. המומחים שלנו מתאימים דלתות מותאמות אישית לכל לקוח.</p>
            </Col>
            <Col xs={12} md={4}
              data-aos="fade-right"
              data-aos-once={true}
