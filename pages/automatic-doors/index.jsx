                            ...
                            <div className={styles.contentInner}>
                                ...
                                <div className={styles.contentText}>
                                    <div className={`${styles.contentTextInner} ${styles.mainContextInner}`}>
                                        ...
                                        {/* <br /> */}
                                        {/* לחברתנו יש את הבלעדיות לשעון שבת אסטרונומי המותאם לדלתות הזזה אוטומטיות אשר הומצא על ידנו. מערכת השעון יודעת באופן אוטומטי מתי השבת נכנסת ויוצאת. המערכת מכוונת 15 שנה קדימה ומכירה בכל חגי וזמני ישראל. שעון שבת האסטרונומי עובד לפי שעון רבנו תם ויש לו אישור של צומת ומשמרות השבת. מערכת השעון מאפשרת לדלת להיפתח ולהיסגר לפי זמנים שנקבעו מראש. ברגע שהדלת נפתחת נשמע צפצוף , בכדי ששומר השבת ידע שהוא יכול לעבור באופן חופשי. כאשר הצפצוף נפסק ידע שומר השבת שאסור לא להתקרב לדלת. לאחר סיום הצפצוף המוגדר שנמשך כ-10 שניות הדלת נסגרת. */}
                                        <br />
