                            ...
                            <div className={styles.contentInner}>
                                ...
                                <div className={styles.contentText}>
                                    <div className={`${styles.contentTextInner} ${styles.mainContextInner}`}>
                                        חברת פאר אנפון הינה יבואנית בלעדית של מערכות דלתות אוטומטיות של החברות האירופאיות: TOPP (www.Topp.it), TAU (www.tauitalia.com), ERREKA (www.erreka.com)
                                        <br />
                                        המבטיחות איכות, שירות ואמינות מוצריה. כל המוצרים שלנו עומדים בדרישות של מכון התקנים הישראלי ובתקן האירופאי.
                                        <br />
                                        אנו מציעים מגוון עשיר ורחב היקף של דלתות אוטומטיות וכן מספקים שירותי ייעוץ, תכנון, ייצור, התקנה ותחזוקה של דלתות אוטומטיות לבנייני מגורים, למוסדות, לבתי מלון, לבתי חולים, למרכזים מסחריים ועוד.
                                        <br />
                                        דלת הזזה אוטומטית יכולה להיות בעלת מראה זכוכית עם פרופיל אלומיניום דק או עבה בהתאם לדרישות הלקוח וכמו כן דלתות האוטומטיות יכולות להגיע בכל גוון ובכל מגוון סוגי הזכוכיות לפי טעמו של הלקוח. דלתות אוטומטיות מותקנות על מסילה עילית המקבלות מראה אסתטי ונקי.
                                        <br />
