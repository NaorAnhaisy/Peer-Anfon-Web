...
export default function AutomaticDoorModel() {
  ...
  useEffect(() => {
    ...
    AOS.init({ once: true });
    console.log(automaticDoorsData)
    let foundDoor = automaticDoorsData.find(automaticDoor => {
      return automaticDoor.linkName === modelName
    })
    setDoorData(foundDoor);
  }, [modelName])

  return (
    <div>
      {(doorData && doorData !== {}) ? <div>
